	...
	payments := []struct {
	...
	}{
		{
			MonthlyPayment: MonthlyPayment{
				ID: 1, MonthID: monthID, Title: "Rent", Cost: 20000, Notes: "some notes",
			},
		},
		{
			MonthlyPayment: MonthlyPayment{
				ID: 2, MonthID: monthID, Title: "Loans", Cost: 1000, TypeID: 5,
			},
		},
		{
			MonthlyPayment: MonthlyPayment{
				ID: 3, MonthID: monthID, Title: "Music", Cost: 300,
			},
		},
		{
			MonthlyPayment: MonthlyPayment{
				ID: 4, MonthID: monthID, Title: "Netflix", Cost: 600,
			},
		},
		{
			MonthlyPayment: MonthlyPayment{
				ID: 5, MonthID: monthID, Title: "Patreon", Cost: 1000,
			},
		},
		// With errors
		{
			MonthlyPayment: MonthlyPayment{
				ID: 0, MonthID: monthID, Title: "", Cost: 1000,
			},
			isError: true,
		},
		{
			MonthlyPayment: MonthlyPayment{
				ID: 0, MonthID: monthID, Title: "Some name", Cost: 0,
			},
			isError: true,
		},
		{
			MonthlyPayment: MonthlyPayment{
				ID: 0, MonthID: monthID, Title: "Another name", Cost: -1000,
			},
			isError: true,
		},
	}
...
func TestEditMonthlyPayment(t *testing.T) {
	...
	payments := []struct {
		...
		{
			origin: MonthlyPayment{
				ID: 1, MonthID: monthID, Title: "test", Notes: "123", Cost: 15000,
			},
			edited: &MonthlyPayment{
				ID: 1, MonthID: monthID, Title: "test", Notes: "123", Cost: 12000,
			},
		},
		{
			origin: MonthlyPayment{
				ID: 2, MonthID: monthID, Title: "test", Notes: "123", Cost: 15000,
			},
			edited: &MonthlyPayment{
				ID: 2, MonthID: monthID, Title: "123", Notes: "", Cost: 12000,
			},
		},
		{
			origin: MonthlyPayment{
				ID: 3, MonthID: monthID, Title: "test", Notes: "123", Cost: 15000,
			},
		},
		// With error
		{
			origin: MonthlyPayment{
				ID: 4, MonthID: monthID, Title: "test", Notes: "123", Cost: 15000,
			},
			edited: &MonthlyPayment{
				ID: 4, MonthID: monthID, Title: "", Cost: 100,
			},
			isError: true,
		},
		{
			origin: MonthlyPayment{
				ID: 5, MonthID: monthID, Title: "test", Notes: "123", Cost: 15000,
			},
			edited: &MonthlyPayment{
				ID: 5, MonthID: monthID, Title: "132", Cost: 0,
			},
			isError: true,
		},
		{
			origin: MonthlyPayment{
				ID: 6, MonthID: monthID, Title: "test", Notes: "123", Cost: 15000,
			},
			edited: &MonthlyPayment{
				ID: 6, MonthID: monthID, Title: "Test", Cost: -50,
			},
			isError: true,
		},
	}
